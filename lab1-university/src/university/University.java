...
// R2
	...
	public int enroll(String first, String last){
		sList[numStudent].sName = first;
		sList[numStudent].sSurname = last;
		sList[numStudent].id = 10000 + numStudent;
		numStudent++;
		return 10000 + numStudent - 1;
	}
	...
	public String student(int id){
		...
		return found.id + " " + found.sName + " " + found.sSurname;
	}
